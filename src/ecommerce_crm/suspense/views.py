...
from ecommerce_crm.catalog.models import Product
...
from ecommerce_crm.catalog.models import HeaderFooter
from ecommerce_crm.catalog.models import SpecialCategories
...
from ecommerce_crm.suspense.models import QuotedSuspenseOrder
from ecommerce_crm.suspense.models import Vehicle
from ecommerce_crm.suspense.models import Staff, CarTaxiAdvance
from ecommerce_crm.suspense.models import TransportBillOfSession
from ecommerce_crm.suspense.models import SuspenseClearedRegister
from ecommerce_crm.suspense.forms import Clearance_form
from ecommerce_crm.suspense.forms import SuspenseForm
from ecommerce_crm.suspense.forms import QuotedSuspenseForm
from ecommerce_crm.suspense.forms import TaDaForm
from ecommerce_crm.suspense.forms import TaDaSearch
from ecommerce_crm.suspense.forms import SessionSelectForm
from ecommerce_crm.suspense.forms import TransportForm1
from ecommerce_crm.suspense.forms import CarTaxiAdvance_form

from ecommerce_crm.prints.helper import num2eng

from ecommerce_crm.bills.models import QuotedOrder
from ecommerce_crm.bills.models import QuotedItem

from ecommerce_crm.voucher.models import VoucherId, Distribution
from ecommerce_crm.voucher.models import FinancialSession, CalculateDistribution
from ecommerce_crm.voucher.models import VoucherTotal
    ...
    if field_work and generate_voucher == 1:
        if request.method == 'POST':
            ...
            return HttpResponseRedirect(\
                reverse("ecommerce_crm.catalog.views.bill_cal"))
        else:
...
def clearance_result(request):
    ...
    if request.method == 'POST':
        ...
        return HttpResponseRedirect(\
            reverse('ecommerce_crm.suspense.views.clearance_search'))
...
def quoted_add_distance(request):
    ...
    if field_work and generate_voucher == 1:
        if request.method == 'POST':
            ...
            return HttpResponseRedirect(\
                reverse("ecommerce_crm.bills.views.quoted_bill_cal"))
        else:
        ...
        if form.is_valid():
            if not 'session' in request.POST:
                HttpResponseRedirect(\
                    reverse("ecommerce_crm.suspense.views.sessionselect"))
...
def tada_result(request):
    ...
    if request.method == 'POST':
        ...
        if request.GET['voucher_no']:
            ...
            return HttpResponseRedirect(\
                reverse('ecommerce_crm.suspense.views.tada_order_session'))
...
def car_taxi_advance(request):
    if request.method == 'POST':
        ...
        return HttpResponseRedirect(\
            reverse("ecommerce_crm.suspense.views.car_taxi_advance_form"))
