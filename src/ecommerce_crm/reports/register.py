...
from ecommerce_crm.reports.forms import DailyReportForm
from ecommerce_crm.reports.forms import ConsultancyFunds
from ecommerce_crm.reports.forms import DateRangeSelectionForm
from ecommerce_crm.reports.forms import MonthYearForm, AmountForm
from ecommerce_crm.reports.forms import PaidTaxesForm, LabReportForm

from datetime import datetime
import calendar

from ecommerce_crm.catalog.request_change import request_notify
from ecommerce_crm.catalog.models import PurchaseOrder
from ecommerce_crm.catalog.models import Bill
from ecommerce_crm.catalog.models import PurchasedItem
from ecommerce_crm.catalog.models import Category
from ecommerce_crm.catalog.models import TaxesApplied
from ecommerce_crm.catalog.models import Surcharge
from ecommerce_crm.catalog.models import NonPaymentOrder
from ecommerce_crm.catalog.models import NonPaymentOrderOfSession
from ecommerce_crm.catalog.models import ModeOfPayment

from ecommerce_crm.suspense.models import SuspenseOrder
from ecommerce_crm.suspense.models import Transport
from ecommerce_crm.suspense.models import TaDa, Staff
from ecommerce_crm.suspense.models import SuspenseClearance
from ecommerce_crm.suspense.models import SuspenseClearedRegister

from ecommerce_crm.voucher.models import CalculateDistribution
from ecommerce_crm.voucher.models import VoucherId, VoucherTotal
from ecommerce_crm.voucher.models import Distribution

from ecommerce_crm.bills.models import QuotedOrder
from ecommerce_crm.bills.models import QuotedOrderofSession
from ecommerce_crm.bills.models import QuotedTaxesApplied
from ecommerce_crm.bills.models import QuotedItem
...
def daily_report_result(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid() and date_form.is_valid():
            ...
            back_link=reverse('ecommerce_crm.reports.register.daily_report_result')
...
def consultancy_funds_report(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid() and date_form.is_valid():
            ...
            start_date = datetime.strptime(start_date, '%Y-%m-%d').strftime('%B-%d-%Y')
            end_date = datetime.strptime(end_date, '%Y-%m-%d').strftime('%B-%d-%Y')
            back_link=reverse('ecommerce_crm.reports.register.consultancy_funds_report')
...
def tds_report_result(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            start_date = datetime.strptime(start_date, '%Y-%m-%d').strftime('%B-%d-%Y')
            end_date = datetime.strptime(end_date, '%Y-%m-%d').strftime('%B-%d-%Y')
            back_link=reverse('ecommerce_crm.reports.register.tds_report_result')
...
def payment_register(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            start_date = datetime.strptime(start_date, '%Y-%m-%d').strftime('%B-%d-%Y')
            end_date = datetime.strptime(end_date, '%Y-%m-%d').strftime('%B-%d-%Y')
            back_link=reverse('ecommerce_crm.reports.register.payment_register')
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            for value in suspenseclearance:
                ...
                address = ''
            request_status = request_notify()
            back_link=reverse('ecommerce_crm.reports.register.suspense_clearance_register')
...
def servicetax_register(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid() and data_form.is_valid():
            ...
            back_link=reverse('ecommerce_crm.reports.register.servicetax_register')
...
def main_register(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            request_status = request_notify()
            back_link=reverse('ecommerce_crm.reports.register.main_register')
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            for order in quotedorder:
                ...
                name = ''
            request_status = request_notify()
            back_link=reverse('ecommerce_crm.reports.register.proforma_register')
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            for order in non_payment_order:
                ...
                address = ''
            request_status = request_notify()
            back_link=reverse('ecommerce_crm.reports.register.non_payment_register')
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            for temp_value in purchase_order:
                    ...
                    temp_list = []
            request_status = request_notify()
            back_link=reverse('ecommerce_crm.reports.register.client_register')
...
def material_report(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid() and date_form.is_valid():
            ...
            request_status = request_notify()
            back_link=reverse('ecommerce_crm.reports.register.material_report')
...
def suspense_register(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            request_status = request_notify()
            back_link=reverse('ecommerce_crm.reports.register.suspense_register')
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            for value in user:
                ...
                result.append(temp_list)
            request_status = request_notify()
            back_link=reverse('ecommerce_crm.reports.register.registered_users')
    ...
    if request.method == 'POST':
        ...
        if form.is_valid() and date_form.is_valid():
            ...
            total = PurchasedItem.objects.filter(purchase_order__date_time__range
                ...
                aggregate(Sum('price')).get('price__sum', 0.00)
            request_status = request_notify()
            back_link=reverse('ecommerce_crm.reports.register.lab_report')
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            for suspense in suspenseorder:
                ...
                address = ''
            request_status = request_notify()
            back_link=reverse('ecommerce_crm.reports.register.pending_clearance_register')
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            for voucher in suspense_cleared:
                ...
                result.append(temp)
            request_status = request_notify()
            back_link=reverse('ecommerce_crm.reports.register.tada_register')
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            for voucher in suspense_cleared:
                ...
                result.append(temp)
            request_status = request_notify()
            back_link=reverse('ecommerce_crm.reports.register.tada_othercharges_register')
...
def client_details_according_to_amount(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            request_status = request_notify()
            back_link=reverse('ecommerce_crm.reports.register.client_details_according_to_amount')
