...
from ecommerce_crm.catalog.forms import ItemSelectForm, BuyerForm
from ecommerce_crm.catalog.forms import SpecialCategoriesForm
from ecommerce_crm.catalog.actions import mark_inactive, mark_active 
...
class PurchaseOrderAdmin(AjaxSelectAdmin):
    ...
    def response_change(self, request, obj, post_url_continue=None):
        ...
        request.session['purchase_order_id'] = obj.id
        return HttpResponseRedirect(reverse\
            ("ecommerce_crm.catalog.views.previous_value"))
...
class NonPaymentOrderAdmin(AjaxSelectAdmin):
    ...
    def response_add(self, request, obj, post_url_continue=None):
        ...
        return HttpResponseRedirect(reverse\
            ("ecommerce_crm.catalog.views.nonpaymentorderofsession"))
