...
from ecommerce_crm.catalog.forms import AddCategory
from ecommerce_crm.catalog.forms import ItemSelectForm
from ecommerce_crm.catalog.forms import ChangeRequestForm
from ecommerce_crm.catalog.forms import ProductListForm
...
from ecommerce_crm.voucher.models import CategoryDistributionType
...
def bill_cal(request):
    ...
    return HttpResponseRedirect(reverse\
        ("ecommerce_crm.catalog.views.order_added_success"))
...
def previous_value(request):
    ...
    return HttpResponseRedirect(reverse\
        ("ecommerce_crm.voucher.views.voucher_generate"))
...
def nonpaymentorderofsession(request):
    ...
    return HttpResponseRedirect(\
        reverse("ecommerce_crm.catalog.views.nonpaymentordersuccess"))
