...
from ecommerce_crm.voucher.models import *
...
from ecommerce_crm.suspense.models import SuspenseOrder, Staff
...
def voucher_generate(request):
    ...
    return HttpResponseRedirect(\
        reverse("ecommerce_crm.suspense.views.add_distance"))
