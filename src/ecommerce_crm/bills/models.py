...
from ecommerce_crm.config import _BUYER
from ecommerce_crm.config import _DELIVERY_ADDRESS
from ecommerce_crm.config import _IS_DEBIT
from ecommerce_crm.config import _PURCHASED_ITEMS
from ecommerce_crm.config import _QTY
from ecommerce_crm.config import _REFERENCE
from ecommerce_crm.config import _REFERENCE_DATE
