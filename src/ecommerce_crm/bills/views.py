...
from ecommerce_crm.bills.models import QuotedBill
from ecommerce_crm.bills.models import QuotedItem
from ecommerce_crm.bills.models import QuotedOrderofSession
from ecommerce_crm.bills.models import QuotedOrderNote
from ecommerce_crm.bills.models import NoteLine
from ecommerce_crm.bills.forms import SelectNoteForm
from ecommerce_crm.bills.forms import ItemSelectForm
...
from ecommerce_crm.voucher.models import FinancialSession
...
def quoted_bill_cal(request):
    ...
    return HttpResponseRedirect(reverse("ecommerce_crm.bills.views.select_note"))
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return HttpResponseRedirect(\
                reverse("ecommerce_crm.bills.views.quoted_order_added_success"))
        else:
            return HttpResponseRedirect(\
                reverse("ecommerce_crm.bills.views.quoted_order_added_success"))
    else:
...
def quoted_order_of_session(request):
    ...
    request.session['quoted_order_id'] = quoted_order_id
    return HttpResponseRedirect(\
        reverse("ecommerce_crm.suspense.views.quoted_add_distance"))