...
$(document).ready(function(){
    ...
    $('body').on('change','select.type',function(){
        ...
        type_id = $(this).val();
        reverse('ecommerce_crm.catalog.views.select_type', function(url) {
    ...
    $('body').on('click','select.parent_category',function(){
        ...
        reverse('ecommerce_crm.catalog.views.select_sub_category', function(url) {
    ...
    $('body').on('click','select.sub_category',function(){
        ...
        reverse('ecommerce_crm.catalog.views.select_item', function(url) {
